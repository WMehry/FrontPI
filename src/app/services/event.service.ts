...
export class EventService {
  ...
  private token = 'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJqb3Vqb3UuaXJyZWZyZXhAZ21haWwuY29tIiwiaWF0IjoxNzE1MTgzMTExLCJleHAiOjE3MTUyNjk1MTF9.MxRj0-BlJiwrT0TR0PGzJoy9ngvk3MuwwEhvNrRacNc';
...
getEventInfo(): Observable<string> {
  ...
  getEvent(id: number): Observable<Event> {
    ...
    return this.http.get<Event>(`${this.baseUrl5}/${id}`, { headers:headers });
